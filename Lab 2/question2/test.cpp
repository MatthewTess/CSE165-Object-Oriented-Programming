...
// Employee Class which has a name and wage for each object and has a print function to print these
class Employee {
private:
    string name;
    int wage;
...
// Boss Class which has a name and wage for each object and has a print function to print these and print an employee's, using a pointer, wage and name.
class Boss {
private:
    string name;
    int wage;
